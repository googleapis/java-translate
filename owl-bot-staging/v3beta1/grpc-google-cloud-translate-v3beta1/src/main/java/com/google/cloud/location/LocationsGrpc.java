...
public final class LocationsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.location.ListLocationsRequest,
      com.google.cloud.location.ListLocationsResponse> getListLocationsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.location.ListLocationsRequest,
      com.google.cloud.location.ListLocationsResponse> getListLocationsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.location.ListLocationsRequest, com.google.cloud.location.ListLocationsResponse> getListLocationsMethod;
      ...
      synchronized (LocationsGrpc.class) {
        if ((getListLocationsMethod = LocationsGrpc.getListLocationsMethod) == null) {
          LocationsGrpc.getListLocationsMethod = getListLocationsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.location.ListLocationsRequest, com.google.cloud.location.ListLocationsResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.location.GetLocationRequest,
      com.google.cloud.location.Location> getGetLocationMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.location.GetLocationRequest,
      com.google.cloud.location.Location> getGetLocationMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.location.GetLocationRequest, com.google.cloud.location.Location> getGetLocationMethod;
    if ((getGetLocationMethod = LocationsGrpc.getGetLocationMethod) == null) {
      synchronized (LocationsGrpc.class) {
        if ((getGetLocationMethod = LocationsGrpc.getGetLocationMethod) == null) {
          LocationsGrpc.getGetLocationMethod = getGetLocationMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.location.GetLocationRequest, com.google.cloud.location.Location>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class LocationsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listLocations(com.google.cloud.location.ListLocationsRequest request,
     ...
     * </pre>
     */
    public void getLocation(com.google.cloud.location.GetLocationRequest request,
   ...
   * </pre>
   */
  public static final class LocationsBlockingStub extends io.grpc.stub.AbstractBlockingStub<LocationsBlockingStub> {
   ...
   * </pre>
   */
  public static final class LocationsFutureStub extends io.grpc.stub.AbstractFutureStub<LocationsFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.location.Location> getLocation(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_LOCATIONS:
          serviceImpl.listLocations((com.google.cloud.location.ListLocationsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.location.ListLocationsResponse>) responseObserver);
          break;
        case METHODID_GET_LOCATION:
          serviceImpl.getLocation((com.google.cloud.location.GetLocationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.location.Location>) responseObserver);
          break;
        default:
